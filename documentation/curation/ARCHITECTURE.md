...
## Usage-intent scoring and identity matching — split out

Moved to [IDENTITY_MATCHING.md](IDENTITY_MATCHING.md) 2026-08-05 (this file had grown to ~30K
characters covering several distinct sub-topics — that one alone was most of the growth since the
2026-08-02 design below). Covers: the usage-intent score and its signal re-weighting, the
privacy-decision preference aggregate, the per-household few-shot identity classifier, cross-household
reuse and identity linking, and the mislabeling risk flag.
...
research pass returns). **2026-08-05**: usage-intent scoring and identity matching (per-household
classifier, cross-household linking, mislabeling risk — everything dated 2026-08-03 through
2026-08-05) split out to [IDENTITY_MATCHING.md](IDENTITY_MATCHING.md), keeping this file to the core
pipeline/Curator design plus resource scheduling and rollout phases below.
