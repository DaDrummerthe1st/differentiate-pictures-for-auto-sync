...
| [GAMIFICATION.md](GAMIFICATION.md) | Gamified curation sessions — every confirm/correct/decline round type, the credit mechanic, and how a session feeds per-household and (narrowly) system-wide model training. Split out of [../tags/UX_FLOWS.md](../tags/UX_FLOWS.md)'s narrower identity-only sketch, 2026-08-05. |
