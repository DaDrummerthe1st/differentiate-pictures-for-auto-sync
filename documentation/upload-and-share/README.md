...
A clickable visual companion exists at [../../prototypes/upload-and-share-mockup/](../../prototypes/upload-and-share-mockup/README.md) — static HTML/CSS/JS, no server, nothing hosted externally (open `index.html` directly, or serve it locally). An earlier attempt published the same idea as a claude.ai Artifact instead, which sends content to Anthropic's own hosting outside this project's infrastructure — conflicts with [../policies/POLICY.md](../policies/POLICY.md)'s closed-by-default rule, fixed same session, see `documentation/bugs/claude-bugs/fixed/2026-07-26-published-design-doc-as-an-artifact-sending-project-info-off-the-closed-server.md`. The written files above stay the durable, self-sufficient source of truth per [../../CLAUDE.md](../../CLAUDE.md); the mockup is a viewing convenience, not kept exhaustively in sync with every edit here.
